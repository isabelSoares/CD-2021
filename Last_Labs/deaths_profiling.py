...
print(" - First start_date", data.index[0])
print(" - Last start_date", data.index[-1])
plt.figure(figsize=(3*ts.HEIGHT, ts.HEIGHT))
ts.plot_series(data, x_label='start_date', y_label='deaths', title='DEATHS')
...
plt.figure(figsize=(3*ts.HEIGHT, ts.HEIGHT))
ts.plot_series(day_df, title='Daily deaths', x_label='start_date', y_label='deaths')
plt.xticks(rotation = 45)
...
plt.figure(figsize=(3*ts.HEIGHT, ts.HEIGHT))
ts.plot_series(week_df, title='Weekly deaths', x_label='start_date', y_label='deaths')
plt.xticks(rotation = 45)
...
plt.figure(figsize=(3*ts.HEIGHT, ts.HEIGHT))
ts.plot_series(month_df, title='Monthly deaths', x_label='start_date', y_label='deaths')
...
plt.figure(figsize=(3*ts.HEIGHT, ts.HEIGHT))
ts.plot_series(quarter_df, title='Quarterly deaths', x_label='start_date', y_label='deaths')
...
plt.figure(figsize=(3*ts.HEIGHT, ts.HEIGHT))
ts.plot_series(series, x_label='start_date', y_label='deaths', title='Stationary study', show_std=True)
