...
for key in datas:
    for do_feature_eng in [False, True]:
        ...
        plt.suptitle('QOT Feature Extraction - ' + key + ' - PCA')
        plt.savefig(subDir + 'QOT Feature Extraction - ' + key + ' - PCA')



        print('QOT Feature Extraction - ' + key + ' - PCA 2')
        ...
        plt.suptitle('QOT Feature Extraction - ' + key + ' - PCA 2')
        plt.savefig(subDir + 'QOT Feature Extraction - ' + key + ' - PCA 2')
